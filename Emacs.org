...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'org
    ...
    (customize-set-variable 'org-agenda-custom-commands
                            '(("y" alltodo ""
                               ((org-directory) (org-agenda-files '("Emacs.org"
...
#+begin_src emacs-lisp
  (setq org-capture-templates
        '(("t" "TODO")
          ...
          ("cz" "Shells")
          ("czz" "Zsh" entry (file+olp "~/.dotfiles/Shells.org" "Inbox" "ZSH")
           "* TODO %^{Title}")
...
#+begin_src emacs-lisp
  (use-package app-launcher
    ...
    (dolist (profiles '("browsers/browsers"
                        ...
                        "desktop/desktop"
                        "emacs/emacs"))
      (add-to-list 'app-launcher-apps-directories (concat (getenv "GUIX_EXTRA_PROFILES")
                                                          "/" profiles
                                                          "/share/applications")))
...
* Manifest
:PROPERTIES:
:header-args: :tangle config/.config/guix/manifests/emacs.scm
:GUIX: test
:END:
:HEADER:
