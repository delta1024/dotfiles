...
* User Config
:PROPERTIES:
:header-args: :tangle config/.config/emacs/user-config/user-config-emacs.el
:END:
This section tangles out to =config/.config/emacs/user-config/user-config-emacs.el= unless stated otherwise.
:HEADER:
